...
function initGlossarySearch() {
	const glossaryTerms = [
		'Accuracy Score', 'Activation Function', 'Algorithm', 'Apache Spark', 'API',
		'Artificial Intelligence (AI)', 'Artificial Neural Networks (ANN)',
		'Backpropagation (BP)', 'Bayesian Network', 'Bayes\' Theorem', 'Bias',
		'Bias-Variance Tradeoff', 'Big Data', 'Binomial Distribution', 'Business Analyst',
		'Business Analytics (BA)', 'Business Intelligence (BI)',
		'Categorical Variable', 'Classification', 'Clustering', 'Computer Science',
		'Computer Vision', 'Confusion Matrix', 'Continuous Variable', 'Correlation',
		'Cost Function', 'Covariance', 'Cross-Validation',
		'Dashboard', 'Data Analysis', 'Data Analyst', 'Database', 'Database Management System (DBMS)',
		'Data Consumer', 'Data Engineer', 'Data Engineering', 'Data Enrichment', 'Dataframe',
		'Data Governance', 'Data Journalism', 'Data Lake', 'Data Literacy', 'Data Mining',
		'Data Modeling', 'Data Pipeline', 'Data Science', 'Data Scientist', 'Dataset',
		'Data Structure', 'Data Visualization', 'Data Warehouse', 'Data Wrangling',
		'Decision Tree', 'Deep Learning', 'Dimensionality Reduction',
		'EDA', 'ELT', 'ETL', 'Evaluation Metrics',
		'False Negative', 'False Positive', 'Feature', 'Feature Engineering', 'Feature Selection',
		'F-Score', 'Gradient Descent', 'Hadoop', 'Hyperparameter', 'Hypothesis',
		'Imputation', 'K-Means', 'K-Nearest Neighbors',
		'Linear Algebra', 'Linear Regression', 'Logistic Regression',
		'Machine Learning', 'Mean', 'Mean Absolute Error', 'Mean Squared Error', 'Median',
		'Mode', 'Model Tuning', 'Multivariate Modeling',
		'Naive Bayes', 'Natural Language Processing', 'Normalization', 'NoSQL', 'Null Hypothesis',
		'Open Source', 'Ordinal Variable', 'Outlier', 'Overfitting',
		'Parameter', 'Precision', 'Predictive Analytics', 'Principal Component Analysis',
		'Python', 'R', 'Random Forest', 'Recall', 'Regression', 'Reinforcement Learning',
		'Root Mean Squared Error', 'Sampling Error', 'SQL', 'Standard Deviation',
		'Supervised Learning', 'SVM', 'Synthetic Data',
		'Target Variable', 'Test Set', 'Time Series', 'Training Set',
		'True Negative', 'True Positive', 'Underfitting', 'Univariate Modeling',
		'Unstructured Data', 'Unsupervised Learning', 'Variance', 'Web Scraping', 'Z-Score'
	];
	...
	document.addEventListener('click', (e) => {
		if (!e.target.closest('.glossary-search-container')) {
			dropdown.classList.remove('show');
		}
	});
}
